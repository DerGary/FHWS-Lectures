...
public class SharedPrefManager {
    ...
    public boolean saveDataBase() {
        ...
        _prefEditor.putString(_context.getString(R.string.prefs_events), eventJson);
        _prefEditor.putString(_context.getString(R.string.prefs_docents), docentJson);
        _prefEditor.putString(_context.getString(R.string.prefs_lectures), lectureJson);
        return _prefEditor.commit();
    }

    public void loadDataBase() {
        String eventJson = _pref.getString(_context.getString(R.string.prefs_events), "").toString();
        String docentJson = _pref.getString(_context.getString(R.string.prefs_docents), "").toString();
        String lectureJson = _pref.getString(_context.getString(R.string.prefs_lectures), "").toString();
        Gson gson = ExtendedGson.getInstance();
    ...
    public String getNote(int lectureID) {
        return _pref.getString(LECTURE_TAG + lectureID, _context.getString(R.string.prefs_nonote));
    }
}
